...
import com.study.newboard.entity.BoardEntity;
import com.study.newboard.entity.BoardFileEntity;
import com.study.newboard.repository.BoardFileRepository;
...
public class BoardService {
 ...
 public void save(BoardDTO boardDTO) throws IOException {
     ...
     if (boardDTO.getBoardFile().isEmpty()) {
         ...
         String savePath = "D:/develop-work/workspace/newboard/src/main/resources/image/" + storedFileName; // 4. C:/springboot_img/9802398403948_내사진.jpg
